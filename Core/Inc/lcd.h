...
#define Light_yellow     0xdef0    //浅黄
#define Light_green      0xb6f0    //浅绿
#define Mint_Green       0x86f0    //薄荷绿
#define Light_blue       0x85bb    //浅蓝
#define Light_purple     0xbc1b    //浅紫
#define Light_pink       0xdc18    //浅粉
